        ...
        <div class="kat-bento">
            ...
            <a href="#kategori-laundry" class="kat-card kat-card--mint reveal">
                ...
                <div class="kat-card__icon">
                    <img src="<?php echo esc_url(ORCHID_URI . '/assets/img/icon/icon-chemical-laundry.webp'); ?>" alt="Icon Deterjen Laundry" loading="lazy" width="320" height="180">
                </div>
            </a>
            ...
            <a href="#kategori-parfum" class="kat-card kat-card--lavender reveal">
                ...
                <div class="kat-card__icon">
                    <img src="<?php echo esc_url(ORCHID_URI . '/assets/img/icon/icon-malabeez-parfum.webp'); ?>" alt="Icon Parfum Laundry" loading="lazy" width="320" height="180">
                </div>
            </a>
            ...
            <a href="#kategori-rumah-tangga" class="kat-card kat-card--peach reveal">
                ...
                <div class="kat-card__icon">
                    <img src="<?php echo esc_url(ORCHID_URI . '/assets/img/icon/icon-chemical-household.webp'); ?>" alt="Icon Sabun Pel dan Pembersih Rumah" loading="lazy" width="320" height="180">
                </div>
            </a>
            ...
            <a href="#kategori-sanitasi" class="kat-card kat-card--butter reveal">
                ...
                <div class="kat-card__icon">
                    <img src="<?php echo esc_url(ORCHID_URI . '/assets/img/icon/icon-chemical-sanitasi.webp'); ?>" alt="Icon Sanitasi Care dan Disinfektan" loading="lazy" width="320" height="180">
                </div>
            </a>
            ...
            <a href="#kategori-automotive" class="kat-card kat-card--mint reveal">
                ...
                <div class="kat-card__icon">
                    <img src="<?php echo esc_url(ORCHID_URI . '/assets/img/icon/icon-chemical-autocare.webp'); ?>" alt="Icon Shampoo Mobil dan Semir Ban" loading="lazy" width="320" height="180">
                </div>
            </a>
            ...
            <a href="#kategori-biang" class="kat-card kat-card--lavender reveal">
                ...
                <div class="kat-card__icon">
                    <img src="<?php echo esc_url(ORCHID_URI . '/assets/img/icon/icon-chemical-paket-bahan.webp'); ?>" alt="Icon Biang Konsentrat Sabun" loading="lazy" width="320" height="180">
                </div>
            </a>
